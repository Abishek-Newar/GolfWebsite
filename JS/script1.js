...
var contactFormDB = firebase.database().ref("bookCourse");

document.getElementById("bookCourse").addEventListener("submit", submitForm);
...
function submitForm(e) {
  ...
  //   reset the form
  document.getElementById("bookCourse").reset();
}
